...
@section('title', 'Tambah EventOrganizer') 
@section('content_header') 
    <h1 class="m-0 text-dark">Tambah EventOrganizer</h1>
@stop
@section('content') 
    <form action="{{route('eventorganizer.store')}}" method="post">
        @csrf
    <div class="row">
        <div class="col-12">
            <div class="card">
